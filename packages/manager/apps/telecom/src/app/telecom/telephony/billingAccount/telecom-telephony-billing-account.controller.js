...
angular
  .module('managerApp')
  .controller(
    'TelecomTelephonyBillingAccountCtrl',
    function TelecomTelephonyBillingAccountCtrl(
      $q,
      $translate,
      $stateParams,
        ...
        $q.all([
          ...
          OvhApiOrder.Telephony()
            ...
            .$promise.then((allowedBillingAccounts) => {
              self.canOrderAlias =
                allowedBillingAccounts.indexOf($stateParams.billingAccount) >
                -1;
