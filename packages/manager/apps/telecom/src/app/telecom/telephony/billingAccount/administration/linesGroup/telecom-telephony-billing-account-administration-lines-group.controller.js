...
angular
  ...
  .controller(
    ...
    function TelecomTelephonyBillingAccountAdministrationLinesGroup(
      $scope,
      $stateParams,
      $q,
      $translate,
      ...
      self.fetchBillingAccountServices = function fetchBillingAccountServices(
        ba,
      ) {
        self.services = null;
            ...
            map(self.getServicesToAttachList(), (service) =>
              OvhApiTelephony.Service()
                ...
                .changeOfBillingAccount(
                  {
                    billingAccount:
                      self.billingAccounts.selected.billingAccount,
