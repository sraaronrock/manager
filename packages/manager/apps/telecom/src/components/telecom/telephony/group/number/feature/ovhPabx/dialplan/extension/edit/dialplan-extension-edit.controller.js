...
angular.module('managerApp').controller(
  'DialplanExtensionEditCtrl',
  class DialplanExtensionEditCtrl {
    constructor(
      $scope,
      $q,
      telephonyScheduler,
    ...
    $onInit() {
      ...
      this.groupedTimeConditions = map(
        this.voipTimeCondition.groupTimeConditions(
    ...
    onConditionAddBtnClick(conditionsGroup) {
      ...
      if (
        !moment(
          `${curDate} ${conditionsGroup.slotTimeModel.timeFrom}`,
        ).isBefore(endHourMoment)
      ) {
